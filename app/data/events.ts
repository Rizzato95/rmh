export interface ClubEvent {
  ...
  cover: string; venue: string; address?: string; organizers: string[];
...
export const events: ClubEvent[] = [
  { slug: 'coffee-beats-settembre-2026', title: 'Coffee Beats', subtitle: 'Social run, breakfast & club', startsAt: '2026-09-26T09:45:00+02:00', endsAt: '2026-09-26T23:59:59+02:00', cover: '/images/coffee-september.webp', venue: 'Filò', address: 'Viale Cadorna 8, Treviso', organizers: ['RMH Run Club', 'Disco Break', 'Alpro', 'Filò'], price: 0,
